  ...
  return (
    <div className="">
      <aside
        ...
        aria-label="Sidebar"
      >
        <div className="h-full px-4 py-4 overflow-y-auto bg-[#5E42CE]">
          ...
          <div className="flex items-center justify-center m-auto -mt-5">
            <ul className="flex-col gap-10">
              <li className="absolute flex items-center justify-center inset-x-0 mt-16">
                <button
                  type="button"
                  className="w-[80%] p-3 flex gap-4 text-start justify-start items-center text-sm font-medium text-gray-900 rounded-lg  hover:bg-[#F8A849] hover:text-white focus:z-10 focus:ring-2 focus:ring-[#F8A849] focus:text-black dark:bg-[#6268C6] dark:border-gray-600 dark:text-white dark:hover:text-white dark:hover:bg-[#F8A849] dark:focus:ring-blue-500 dark:focus:text-white"
                >
                  <svg
                    width="29"
                    height="29"
      ...
      <div className=" pl-[280px] h-screen p-5">{children}</div>
    </div>
  );
};
